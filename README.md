...
This test results in a correlation coefficient of ~0.008 which is very small and stands for basically no detectable correlation. The p-value of ~0.66 also does not support a significant result if one takes 0.05 as the significance threshold, as is usually done.
